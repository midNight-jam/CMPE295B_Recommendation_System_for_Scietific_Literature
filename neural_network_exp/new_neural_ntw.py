...
weights = {
    ...
    'decoder_h1': tf.Variable(tf.random_normal([num_hidden_3, num_hidden_2], dtype=tf.float64)),
    'decoder_h2': tf.Variable(tf.random_normal([num_hidden_2, num_hidden_1], dtype=tf.float64)),
    'decoder_h3': tf.Variable(tf.random_normal([num_hidden_1, num_input], dtype=tf.float64))
}
...
biases = {
    ...
    'decoder_b2': tf.Variable(tf.random_normal([num_hidden_1], dtype=tf.float64)),
